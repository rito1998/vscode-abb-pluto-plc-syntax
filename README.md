...
This [Visual Studio Code Extension](https://marketplace.visualstudio.com/items?itemName=rito1998.vscode-abb-pluto-plc-syntax) enables basic syntax highlighting for **sps** and **fps** files used with the Pluto Manager software to program ABB Pluto Safety PLCs.
